...
if ( ! class_exists( 'apt_pricingtable' ) ) {
	class apt_pricingtable {	
		...
		public function apt_upgrade_pro() { ?>
			<img src="<?php echo APT_PLUGIN_URL ?>img/2017-12-08_20-43-13.png"/ width="250" height="280">
		...
		public function apt_pricing_upload($post) {
			wp_enqueue_style('apt-bootstrap-css', APT_PLUGIN_URL .'css/bootstrap.css');			
			
			require_once('add-new-pricing.php');
		...
		public function apt_theme_page() {
